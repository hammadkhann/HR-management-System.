...
namespace HR
{
    public partial class MDIParent1 : Form
    {
        ...
        private void allOpenJobsToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            ScheuleInterview schedule = new ScheuleInterview();
            schedule.Show();
        }

        private void interviewStatusToolStripMenuItem_Click(object sender, EventArgs e)
        {
            InterviewStatus interviewStatus = new InterviewStatus();
            interviewStatus.Show();
        }
    }
}
